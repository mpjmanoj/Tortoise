      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12 relative z-10">
        ...
        <div className="col-span-1 lg:col-span-1">
          <div className="flex flex-col">
            ...
            <span className="text-xs font-medium text-stone-500 uppercase tracking-widest mt-1">Tortoise Guardians</span>
          </div>
          <p className="text-sm leading-relaxed text-stone-400 mb-6">
            A community-led effort to protect the ancient tortoise. Small actions. Real change.
          </p>
